...
public:
	...
	bool GetRandomRewardOptionEntries(TArray<FHRewardOptionEntry>& OutOptions);
	...
	void ExecuteRewardForPlayer(class AHPlayerCharacter* InPlayerCharacter, class AHPlayerState* InPlayerState, const FHRewardOptionData& InSelectedOption);

	bool FindRewardOptionByRowName(FName InRowName, FHRewardOptionData& OutOption) const;
	...
	bool IsRewardDataReady() const { return GradeDataAsset != nullptr && RewardDataTable != nullptr; }
